...
public class RegistroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView lista = vista.findViewById(R.id.listaRegistros);
        sharedpreferences = getActivity().getSharedPreferences(MyPREFERENCES2,Context.MODE_PRIVATE); //Para extraer el nombre de usuario
        //
